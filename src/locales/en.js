const en = {
    ...
    childcareAskGender: "Baby's gender?\n1. Boy  2. Girl",
    childcareAskWakeUp: 'What time do you (parent) wake up? (e.g., 7am, 07:00)',
    ...
    childcareMode: 'Childcare',
    childcareNoEvents: 'No childcare events scheduled',
    childcareNoEventsHint: 'Try "childcare schedule" in chat to create one!',
    childcareDeleteConfirm: 'Delete this event?',
    childcareChildName: 'Name',
    childcareBirthdate: 'Birthdate',
    childcareAgeMonths: 'Age',
    childcareMonthUnit: ' months',
    childcareGenderBoy: 'Boy',
    childcareGenderGirl: 'Girl',
    childcareCategoryFeeding: 'Feeding',
    childcareCategorySleep: 'Sleep',
    childcareCategoryPlay: 'Play',
    childcareCategoryBath: 'Bath',
    childcareCategoryDiaper: 'Diaper',
    childcareCategoryOuting: 'Outing',
    childcareCategoryHospital: 'Hospital',
