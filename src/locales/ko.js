const ko = {
    ...
    childcareAskGender: '아이 성별은?\n1. 남아  2. 여아',
    childcareAskWakeUp: '보호자(부모) 기상 시간은? (예: 7시, 07:00)',
    ...
    childcareMode: '육아',
    childcareNoEvents: '등록된 육아 일정이 없습니다',
    childcareNoEventsHint: '채팅에서 "육아 스케줄 짜줘"로 생성해보세요!',
    childcareDeleteConfirm: '이 일정을 삭제하시겠습니까?',
    childcareChildName: '이름',
    childcareBirthdate: '생년월일',
    childcareAgeMonths: '월령',
    childcareMonthUnit: '개월',
    childcareGenderBoy: '남아',
    childcareGenderGirl: '여아',
    childcareCategoryFeeding: '수유/식사',
    childcareCategorySleep: '수면',
    childcareCategoryPlay: '놀이',
    childcareCategoryBath: '목욕',
    childcareCategoryDiaper: '기저귀',
    childcareCategoryOuting: '외출',
    childcareCategoryHospital: '병원',
