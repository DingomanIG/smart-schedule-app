  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">문의하기</h1>
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 space-y-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <div className="mt-4">
            <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">문의 유형 안내</h2>
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 mt-6 text-sm text-gray-700 dark:text-gray-300">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">기타 연락처</h2>
          <p>
            긴급한 문의사항은 아래 이메일로 직접 연락해 주세요.
          </p>
          <p className="mt-2 text-blue-600 dark:text-blue-400">support@smartschedule.app</p>
        </div>
      </div>
    </div>
  )
