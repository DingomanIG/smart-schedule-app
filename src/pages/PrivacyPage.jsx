    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 space-y-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">1. 수집하는 개인정보 항목</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">2. 개인정보의 수집 및 이용 목적</h2>
          <ul className="list-disc list-inside space-y-1">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">5. 개인정보의 안전성 확보 조치</h2>
          <p>
          ...
          <p>
            ...
            <Link to="/contact" className="text-blue-600 dark:text-blue-400 hover:underline">문의하기</Link> 페이지를
            이용해 주세요.
          </p>
