    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-6 space-y-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">제3조 (약관의 효력 및 변경)</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">제4조 (회원가입 및 서비스 이용)</h2>
          <p>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">제5조 (서비스의 제공)</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">제6조 (이용자의 의무)</h2>
          ...
          <h2 className="text-lg font-semibold text-gray-900 dark:text-white">제7조 (면책조항)</h2>
          <p>
          ...
          <p className="text-xs text-gray-400 dark:text-gray-500 mt-6">시행일: 2026년 2월 16일</p>
        </div>
      </div>
    </div>
  )
